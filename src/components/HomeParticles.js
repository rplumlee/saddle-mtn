...
export default function HomeParticles({ children, location }) {
  ...
  return (
    <>
      <div className="infolayer theme-bg-tertiary"></div>
      <div className="infographic-container theme-bg">
        ...
        >
          40 Years of High-Tech Sales Success
        </h1>
        <p
          style={{
            textAlign: 'center',
        ...
        <div className="theme-text home-infographic">
          ...
          >
            ...
            /> */}
              ...
              <text
                className="fact hack"
                transform="matrix(1 0 0 1 107.2083 454.1566)"
                fontSize="17.5701"
              >
                <g>
                  <GiPerson />
              ...
              <text
                ...
                transform="matrix(1 0 0 1 91.5007 525.9017)"
                fontSize="17.5701"
              >
                <GiPerson />
              </text>
              <text
                className="hack"
                transform="matrix(1 0 0 1 69.6087 597.6449)"
                fontSize="17.5701"
              >
                <GiPerson />
              </text>
              <text
                className="marketPath exact cty eby ifttt pg find cnet bbye cow hack"
                transform="matrix(1 0 0 1 118.031 669.392)"
                fontSize="17.5701"
              >
                <GiPerson />
              </text>
              <text
                className="marketPath exact cty eby ifttt pg find cnet bbye cow hack"
                transform="matrix(1 0 0 1 69.2923 741.1342)"
                fontSize="17.5701"
              >
                <GiPerson />
              </text>
              <text
                className="marketPath exact cty eby ifttt pg find cnet bbye cow hack"
                transform="matrix(1 0 0 1 139.8181 812.9518)"
                fontSize="17.5701"
              >
                <GiPerson />
              </text>
